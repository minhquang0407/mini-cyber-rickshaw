...
# Ép buộc đăng ký môi trường Generated Track
try:
    register(
        id="donkey-generated-track-v0",
        entry_point="gym_donkeycar.envs.donkey_env:GeneratedTrackEnv",
    )
    print(">>> [FIX] Đã đăng ký thủ công môi trường: donkey-generated-track-v0")
except Exception as e:
    print(f">>> [INFO] Môi trường đã tồn tại hoặc lỗi: {e}")

# Ép buộc đăng ký môi trường Warehouse (Phòng hờ nếu bạn muốn đổi map)
try:
    register(
...
def add_simulator(V, cfg):
    ...
    if cfg.DONKEY_GYM:
        ...
        # rbx
        gym = DonkeyGymEnv(cfg.DONKEY_SIM_PATH, host=cfg.SIM_HOST, env_name="donkey-generated-track-v0", conf=cfg.GYM_CONF,
